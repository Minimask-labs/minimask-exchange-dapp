  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
        <DialogContent className="sm:max-w-[400px] bg-card border-minimask-border">
          <DialogHeader>
          ...
          <div className="space-y-6">
              ...
              <div className="flex gap-2">
                {gasPriceOptions.map((option) => (
                  <button
                    key={option.value}
                    onClick={() =>
                      onSettingsChange({ ...settings, gasPrice: option.value })
                    }
                    className={cn(
                      'flex-1 py-2 px-3 rounded-lg text-sm font-medium transition-colors',
            ...
            <div>
              ...
              <div className="flex gap-2">
                <button
                  onClick={() =>
                    onSettingsChange({ ...settings, slippage: 'auto' })
                  }
                  className={cn(

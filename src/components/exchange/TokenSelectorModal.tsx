...
const TokenSelectorModal = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-[480px] bg-card border-jumper-border p-0 gap-0">
        ...
        <div className="flex flex-1 min-h-[400px]">
          ...
          <div className="w-16 border-r border-jumper-border flex flex-col items-center py-2 gap-1">
            <button
